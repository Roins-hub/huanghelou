...
Assert-NotContains $js "function initStartPointerScanner" "script.js should not initialize a start page gesture pointer scanner."
Assert-NotContains $js "function updateStartPointer" "script.js should not move a start page gesture cursor."
Assert-NotContains $js "function triggerStartPointerClick" "script.js should not simulate start page gesture cursor clicks."
Assert-NotContains $js "initStartPointerScanner()" "start page initialization should not request camera access for gesture navigation."
